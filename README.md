...
&nbsp;
- 💛 twenty-six, she/her, queer, austria, ex web dev

- 📜 I code `.html`, `.scss`, `.js`, `.php`, etc.

- 🧸 I have a [neocities website](https://petrapixel.neocities.org/) to appreciate the old web

- 🪶 I make helpful little [userscripts](https://greasyfork.org/en/users/354138-petracoding) on greasyfork
